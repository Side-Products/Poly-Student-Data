  ...
  const loadMyResult = async () => {
    ...
    try {
      ...
      if (data.student) {
        ...
        try {
          const resultData = await calculateStudentResult(data.student.id);
    ...
    return (
      <div className="max-w-6xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-gray-600 mt-2">View your examination results</p>
        </div>
        <Card>
          <CardContent className="py-12">
            <p className="text-center text-gray-500">
              Your results are not available yet. Please check back later.
            </p>
          </CardContent>
        </Card>
      </div>
